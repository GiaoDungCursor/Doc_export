...
- [Tải Office Studio AI v1.0.1 (.exe)](https://github.com/GiaoDungCursor/Doc_export/releases/download/v1.0.1/Office.Studio.AI-1.0.1.exe)
...
```text
release/Office Studio AI-1.0.1.exe
```
